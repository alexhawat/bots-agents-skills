...
scripts are **not** in this skill folder — they live in a clone of the
`alexhawat/bots-agents-skills` repository. This skill tells you where the
clone is and how to run it.
