# Discogs-Bot (Hermes pack)

Hermes skill + persona for the Discogs session-replay bot. This pack is
**instructions only** — the runnable scripts (27 task slugs, stdlib-only
Python, shared `_lib/`) live in `grok_bots/discogs-bot/` in this repo and are
referenced from a local clone, never copied.

**Repo:** https://github.com/alexhawat/bots-agents-skills
**Path:** `hermes/discogs-bot/`
